      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center relative z-10">
        <div className="space-y-8 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-slide-up animation-delay-200">
            Senior Quality Assurance professional with over 10 years of expertise testing in both manual and automated testing across web, mobile, and API platforms.
          </p>
