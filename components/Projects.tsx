...
const projects = [
  {
    ...
    description: "Playwright test automation suite for the PMO Assistant application. End-to-end tests covering core user workflows and functionality.",
    tech: ["Playwright", "JavaScript", "TypeScript"],
    github: "https://github.wwt.com/custom-apps/summarize-docs-ui-tests",
    demo: "",
    image: "/playwright-logo.svg",
  },
  {
    id: 2,
    title: "Cypress Tests",
